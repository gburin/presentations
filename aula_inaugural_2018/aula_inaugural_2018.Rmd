...
# Minha trajetória {data-notes="Na iniciação e no mestrado eu trabalhei com dendrocronologia. Ao fim do mestrado, percebi que continuar não era a melhor escolha. O que fazer então?" .subtitle}
...
<img src="img/denied.gif" width=250%/>

# 1º capítulo aceito {.subtitle}

# {data-background="img/doctor_no.gif" .center}
...
<img class="fragment" src="img/yeah_no.gif" width=200%/>

# 1º capítulo publicado {data-notes="Mudanças: terapia + remédio. Fim de 2015 (metade do 3o ano) eu pesava 201kg, e resolvi que a melhor coisa a fazer seria a cirurgia bariátrica." .center}
...
# A pós-graduação é mais que seu projeto! {data-notes="Ao mesmo tempo, tentar aproveitar e criar um ambiente bom de trabalho, com uma equipe legal." .subtitle}
