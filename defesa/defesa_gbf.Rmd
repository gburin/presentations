...
# {data-notes="O balanço entre esses dois processos durante milhões de anos, modulados por diferentes mecanismos como por exemplo eventos geológicos, que determina a diversidade em um momento no tempo." data-background="img/marine_fossil_history.gif" data-background-size=75%}
...
# {data-notes="No entanto, apesar de ao pensarmos em evolução geralmente associarmos a fósseis, eles representam um dos extremos de um espectro de disponibilidade de dados, como um dos grupos extintos de dinosauros. No outro lado do espectro estão grupos com registro fóssil ruim e apenas espécies vivas." data-background="img/data_types.png" data-background-size=60%}
...
# Dados de dieta {data-notes="Cientistas compilam dados também" data-background="img/kissling_data.png" data-background-size=80%}

# {data-notes="R+diversitree. Abordagem implementada no pacote. Taxas de especiação, extinção e transição pra cada estado. Transições são mudanças anagenéticas, ou seja, sem especiação" data-background="img/r_diversitree.png" data-background-size=70%}
...
- Incorporar incerteza filogenética (200 árvores - 9871 espécies)
- Especiação, extinção e transições para 9 dietas - Carnívoros, Frugívoros, Granívoros, Herbívoros, Insetívoros, Nectarívoros, Onívoros, Piscívoros e Carniceiros (93 parâmetros)
...
# {data-notes="Para representar o papel dessas espécies em uma rede, usamos diferentes métricas. Nesse exemplo de uma rede de relacionamentos, vemos que dependendo da métrica o nó mais central muda, então elas podem ser usadas para representar diferentes papéis ecológicos em redes de interação" data-background="img/network_metrics.png" data-background-size=50%}
...
# Discussão {data-notes="Fenologia: janela temporal mais restrita em regiões temperadas, match tem que ser preciso; nos trópicos é menos restrito. Trópicos: maior riqueza pode suprir intimidade" .center}
