...
# Bayes Factors {.center}
```{r echo = FALSE, warning = FALSE}
data(mcmc.whales)
knitr::kable(computeBayesFactors(mcmc.whales, expectedNumberOfShifts = 1, burnin = 0.1))
```

# Efeito das *priors* {.center}
```{r echo = FALSE}
